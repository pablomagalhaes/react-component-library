...
import React__default, { useCallback, forwardRef, Component, createElement, PureComponent, useRef, useEffect, useDebugValue, useContext, useState } from 'react';
...
function Col(props) {
  ...
  return /*#__PURE__*/React__default.createElement(Tag, _extends$2({}, modifiedAttributes, {
    className: classes
  }));
}
...
const DropdownContext = React__default.createContext({});

const InputGroupContext = React__default.createContext({});
...
class Dropdown extends React__default.Component {
  constructor(props) {
    ...
    this.menuRef = React__default.createRef();
    this.toggleRef = React__default.createRef(); // ref for DropdownToggle
  }
  ...
  render() {
    ...
    if (setActiveFromChild) {
      React__default.Children.map(this.props.children[1].props.children, dropdownItem => {
    ...
    if (this.context.insideInputGroup) {
      ...
      }, /*#__PURE__*/React__default.createElement(Manager, null, React__default.Children.map(this.props.children, child => React__default.cloneElement(child, {
    ...
    return /*#__PURE__*/React__default.createElement(DropdownContext.Provider, {
      value: this.getContextValue()
    }, /*#__PURE__*/React__default.createElement(Manager, null, /*#__PURE__*/React__default.createElement(Tag, _extends$2({}, attrs, {
...
function ButtonDropdown(props) {
  return /*#__PURE__*/React__default.createElement(Dropdown$1, _extends$2({
    group: true
  }, props));
}
...
class DropdownItem extends React__default.Component {
  constructor(props) {
    super(props);
    this.onClick = this.onClick.bind(this);
...
class DropdownMenu extends React__default.Component {
  getRole() {
    if (this.context.menuRole === 'listbox') {
      return 'listbox';
    }
  ...
  render() {
    ...
    if (persist || this.context.isOpen && !this.context.inNavbar) {
      ...
      const popper = /*#__PURE__*/React__default.createElement(Popper, {
      ...
      if (container) {
        return ReactDOM__default.createPortal(popper, getTarget(container));
      }
...
class DropdownToggle extends React__default.Component {
  constructor(props) {
    super(props);
    this.onClick = this.onClick.bind(this);
  }
  ...
  render() {
    ...
    const children = typeof props.children !== 'undefined' ? props.children : /*#__PURE__*/React__default.createElement("span", {
    ...
    if (this.context.inNavbar) {
      return /*#__PURE__*/React__default.createElement(Tag, _extends$2({}, props, {
        className: classes,
        onClick: this.onClick,
...
class Collapse extends Component {
  constructor(props) {
    ...
    this.nodeRef = props.innerRef || React__default.createRef();
  ...
  render() {
    ...
    const transitionProps = pick(otherProps, TransitionPropTypeKeys);
    const childProps = omit(otherProps, TransitionPropTypeKeys);
    return /*#__PURE__*/React__default.createElement(Transition$1, _extends$2({}, transitionProps, {
      in: isOpen,
      ...
      return /*#__PURE__*/React__default.createElement(Tag, _extends$2({}, childProps, {
...
const CarouselContext = React__default.createContext({});

const _excluded$G = ["in", "children", "cssModule", "slide", "tag", "className"];

class CarouselItem extends React__default.Component {
  constructor(props) {
    super(props);
    this.state = {
...
class Carousel extends React__default.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (slidesOnly) {
      return /*#__PURE__*/React__default.createElement("div", _extends$2({}, attributes, {
        className: outerClasses,
        onMouseEnter: this.hoverStart,
        onMouseLeave: this.hoverEnd
      }), /*#__PURE__*/React__default.createElement(CarouselContext.Provider, {
        value: this.getContextValue()
    ...
    const wrappedIndicators = React__default.cloneElement(indicators, {
...
function CarouselControl(props) {
  ...
  return (
    ...
    React__default.createElement("a", _extends$2({}, attributes, {
...
class UncontrolledCarousel extends Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React__default.createElement(Carousel$1, _extends$2({
...
class PopperContent extends React__default.Component {
  constructor(props) {
    super(props);
  ...
  renderChildren() {
    ...
    return /*#__PURE__*/React__default.createElement(Fade, _extends$2({}, popperTransition, attrs, {
      in: isOpen,
  ...
  render() {
    ...
    if (this.state.isOpen) {
      return this.props.container === 'inline' ? this.renderChildren() : ReactDOM__default.createPortal( /*#__PURE__*/React__default.createElement("div", {
        ref: this.getRef
...
class TooltipPopoverWrapper extends React__default.Component {
  constructor(props) {
    super(props);
    this._targets = [];
  ...
  render() {
    ...
    return /*#__PURE__*/React__default.createElement(PopperContent$1, {
      className: className,
      target: target,
      isOpen: isOpen,
      hideArrow: hideArrow,
      ...
      update
    }) => /*#__PURE__*/React__default.createElement("div", _extends$2({}, attributes, {
      ref: this.getRef,
      className: classes,
      role: "tooltip",
...
function Popover(props) {
  ...
  return /*#__PURE__*/React__default.createElement(TooltipPopoverWrapper$1, _extends$2({}, props, {
...
class UncontrolledPopover extends Component {
  ...
  render() {
    return /*#__PURE__*/React__default.createElement(Popover, _extends$2({
...
class Modal extends React__default.Component {
  ...
  render() {
    ...
    if (!!this._element && (this.state.isOpen || !unmountOnClose)) {
      ...
      const Backdrop = backdrop && (hasTransition ? /*#__PURE__*/React__default.createElement(Fade, _extends$2({}, backdropTransition, {
        in: isOpen && !!backdrop,
        cssModule: cssModule,
      ...
      }, /*#__PURE__*/React__default.createElement(Fade, _extends$2({}, modalAttributes, modalTransition, {
        in: isOpen,
...
class Offcanvas extends React__default.Component {
  constructor(props) {
    super(props);
    this._element = null;
    this._originalBodyPadding = null;
  ...
  render() {
    ...
    if (!!this._element && (this.state.isOpen || !unmountOnClose)) {
      ...
      return /*#__PURE__*/React__default.createElement(Portal$1, {
        node: this._element
      }, /*#__PURE__*/React__default.createElement(Fade, _extends$2({}, attributes, offcanvasAttributes, offcanvasTransition, {
        in: isOpen,
        onEntered: this.onOpened,
        onExited: this.onClosed,
        cssModule: cssModule,
...
class TabContent extends Component {
  ...
  render() {
    ...
    }, /*#__PURE__*/React__default.createElement(Tag, _extends$2({}, attributes, {
      className: classes
    })));
  }
...
class UncontrolledButtonDropdown extends Component {
  ...
  render() {
    return /*#__PURE__*/React__default.createElement(ButtonDropdown, _extends$2({
      isOpen: this.state.isOpen,
      toggle: this.toggle
...
class UncontrolledCollapse extends Component {
  ...
  render() {
    return /*#__PURE__*/React__default.createElement(Collapse$1, _extends$2({
      isOpen: this.state.isOpen
...
var NewTable = function (_a) {
    ...
    function (_a) {
        ...
        return (React__default.createElement("div", __assign({}, row.getRowProps({
            ...
            return (React__default.createElement("div", __assign({}, cell.getCellProps({
                // @ts-ignore
    ...
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(Button$1, { color: "primary", onClick: undoData, size: "md", className: "shadow-sm mr-1", "data-tip": true, "data-for": "UndoTip" },
            React__default.createElement(CornerUpLeft$1, { className: "feather", size: 30, style: { marginTop: "-5px" } }),
            React__default.createElement("span", { style: { padding: "5px" } }, "Undo")),
        React__default.createElement(Button$1, { color: "primary", onClick: saveChanges, "data-tip": true, "data-for": "SaveChangeTip", className: "shadow-sm mr-1" }, "Save Changes"),
        React__default.createElement(Button$1, { color: "primary", onClick: resetData, "data-tip": true, "data-for": "ResetTableTip", className: "shadow-sm mr-1" }, "Reset"),
        exportExcel &&
            (React__default.createElement(React__default.Fragment, null,
                React__default.createElement(Button$1, { color: "primary", "data-tip": true, "data-for": "ExcelTableTip", className: "shadow-sm" },
                    React__default.createElement(Download$1, { className: "feather", size: 30, style: { marginTop: "-5px" } }),
        ...
        React__default.createElement("div", { className: "react_table--wrapper", style: { marginTop: "30px" } },
            React__default.createElement("table", __assign({}, getTableProps(), { 
                // ref={react_table} 
                id: "react_table" }),
                React__default.createElement("thead", null, headerGroups.map(function (headerGroup) { return (React__default.createElement("tr", __assign({}, headerGroup.getHeaderGroupProps()), headerGroup.headers.map(function (column) {
                    return (React__default.createElement("th", __assign({}, column.getHeaderProps(), { className: "Colheader", onClick: function (e) {
                            handleClick(e);
                        } }), column.render("Header")));
                }))); })),
                React__default.createElement("tbody", __assign({}, getTableBodyProps()),
                    React__default.createElement(FixedSizeList, { height: 400, itemCount: rows.length, itemSize: 35, width: totalColumnsWidth + scrollBarSize }, RenderRow))))));
};
